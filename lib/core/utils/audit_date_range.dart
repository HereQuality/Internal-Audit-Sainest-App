...
// bogus far-future end date can't blow up into thousands of events. Used by
// screens/calendar/calendar_screen.dart so a multi-day audit reads as "live"
// on every one of its days, not just its start date.
